        ...
        <div className="bg-[#0a0a0a] text-[#f0ede6] min-h-screen font-['Instrument_Sans']">
            <nav className="fixed top-0 left-0 right-0 z-[60] flex items-center justify-between px-6 md:px-12 py-4 md:py-5 bg-[#0a0a0a]/85 backdrop-blur-xl border-b border-white/7">
                ...
                <div className="flex items-center gap-6 md:gap-8">
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <a href="#pricing" className="text-gray-500 text-sm hover:text-white transition-colors">
                            {t('landing_pricing')}
                        </a>
                    </div>
            ...
            <div className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-32 pb-20 bg-[radial-gradient(ellipse_60%_50%_at_50%_0%,rgba(200,245,90,0.1)_0%,transparent_70%)]">
                ...
                <h1 className="font-['Clash_Display'] text-[44px] md:text-[88px] font-bold leading-[1.1] md:leading-[1.0] tracking-[-0.03em] mb-5">
                    ...
                    <br />
                    <span className="text-[#c8f55a]">{t('landing_hero_title2')}</span>
                    <br />
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    <Link
                        href="/auth"
                        className="bg-[#c8f55a] text-[#0a0a0a] px-9 py-4 rounded-full text-base font-semibold hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                    >
                        {t('landing_start')} →
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mt-16 max-w-2xl w-full">
                    {[
                        ...
                        <div key={l} className="text-center">
                            <div className="font-['Clash_Display'] text-2xl md:text-3xl font-bold text-[#c8f55a]">
                                {n}
                            </div>
            ...
            <section id="how" className="max-w-6xl mx-auto px-6 py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-px md:bg-white/5 rounded-2xl overflow-hidden border border-white/5 md:border-none">
                    {steps.map((s, i) => (
                        <div
                            key={i}
                            className="bg-[#111] p-7 md:p-8 flex flex-col items-start text-left border border-white/5 md:border-none rounded-2xl md:rounded-none"
                        >
            ...
            <section id="features" className="max-w-6xl mx-auto px-6 py-0 pb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {features.map((f, i) => (
                        <div
                            key={i}
                            className="bg-[#111] border border-white/7 rounded-2xl p-7 md:p-8 hover:border-white/20 transition-colors"
                        >
                            <div className="w-11 h-11 bg-[#c8f55a]/8 rounded-xl flex items-center justify-center text-xl mb-5">
                                {f.icon}
                            </div>
            ...
            <section id="pricing" className="max-w-6xl mx-auto px-6 py-0 pb-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    {[
                        ...
                        <div
                            key={i}
                            className={`relative p-8 rounded-2xl border ${plan.best ? 'bg-[#c8f55a]/[0.02] border-[#c8f55a]' : 'bg-[#111] border-white/7'
                                }`}
                        >
                            {plan.best && (
                            ...
                            <ul className="space-y-3 mb-8">
                                {plan.features.map((f, fi) => (
                                    <li key={fi} className="text-sm text-gray-400 flex items-center gap-2.5">
                                        <span className="text-[#c8f55a] font-bold text-xs shrink-0">✓</span>
                                        {f}
                                    </li>
                                ))}
                            ...
                            <Link
                                href="/auth"
                                className={`block w-full text-center py-3.5 rounded-full text-sm font-semibold transition-all ${plan.best
                                    ? 'bg-[#c8f55a] text-[#0a0a0a] hover:opacity-90'
