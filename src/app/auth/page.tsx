...
export default function AuthPage() {
  ...
  // URL'dan xatolarni o'qish (callback'dan qaytgan bo'lishi mumkin)
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <div className="text-3xl font-bold mb-1" style={{ fontFamily: 'var(--font-clash)' }}>
        ...
        <div className="bg-[#111] border border-white/8 rounded-2xl p-6">
            ...
            {mode === 'register' && (
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0a0a0a] border border-white/10 text-white px-4 py-3 rounded-xl text-sm focus:outline-none focus:border-[#c8f55a] transition-colors placeholder:text-gray-700"
                />
              </div>
            )}
          ...
          <button
            ...
            className="w-full py-3 rounded-xl border border-white/10 text-sm font-medium text-gray-300 hover:border-white/20 hover:text-white transition-all flex items-center justify-center gap-2"
          >
